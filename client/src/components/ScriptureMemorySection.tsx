        ...
        <CardHeader className={cn("relative z-10 border-b py-4 px-6", backgroundImage ? "bg-gradient-to-r from-blue-500/10 to-transparent" : "bg-blue-700")}>
          <div className="flex items-center gap-5">
            ...
            <div className="flex-1 space-y-1">
              <CardTitle className={cn("flex items-center justify-center gap-3 text-xl font-semibold tracking-tight whitespace-nowrap", backgroundImage ? "text-white" : "text-white")}>
