...
export interface Translations {
  ...
  emailCommunicationsLabel: string;
  emailCommunicationsDesc: string;
  sendGridLabel: string;
  sendGridDesc: string;
...
export const translations: Record<string, Translations> = {
  en: {
    ...
    personalInfoDesc: "When you register or subscribe to daily reminders, we collect your first name, last name, email address, phone number (optional), and birth month/day (optional) to personalize your spiritual journey and send you daily Scripture emails.",
    usageData: "Usage Data",
    usageDataDesc: "We track your daily app usage, streak counters, verse preferences, Bible trivia progress, and language settings to improve your experience and provide personalized content.",
    ...
    useSendRelevantContent: "Send daily reminder emails with Scripture verses, meanings, applications, and Bible trivia updates (only if you subscribe)",
    ...
    noSellingDesc: "We do not sell, rent, or trade your personal information to third parties for marketing purposes.",
    ...
    dataStorageSecurityDesc: "Your personal information is stored locally on your device and on secure servers (PostgreSQL database). Email delivery is handled by SendGrid, a trusted third-party email service provider. We implement appropriate security measures to protect your data from unauthorized access, alteration, disclosure, or destruction.",
    ...
    emailCommunicationsLabel: "Daily Reminders:",
    emailCommunicationsDesc: "If you subscribe to daily reminder emails, you will receive one email per day at 7:00 AM with today's Scripture verse, meaning, application, and Bible trivia updates. These emails are personalized using your first name.",
    sendGridLabel: "Email Service Provider:",
    sendGridDesc: "We use SendGrid, a trusted third-party email delivery service, to send daily reminder emails. SendGrid may process your email address and name to deliver these emails. View SendGrid's privacy policy at https://www.twilio.com/legal/privacy",
    unsubscribeLabel: "Unsubscribe:",
    unsubscribeDesc: "You can unsubscribe from daily emails at any time by clicking the unsubscribe link at the bottom of any email, or by turning off Daily Reminders in the app settings. Your unsubscribe request will be processed immediately.",
    ...
    tosSection10Email: "thegospelinfiveminutes@gmail.com",
    ...
    // Bible Studies Page
    bibleStudiesTitle: "Classic Bible Studies",
    bibleStudiesSubtitle: "Timeless devotional works from beloved Christian authors",
  ...
  es: {
    ...
    emailCommunicationsLabel: "Recordatorios Diarios:",
    emailCommunicationsDesc: "Si se suscribe a los correos de recordatorio diarios, recibirá un correo por día a las 7:00 AM con el versículo de las Escrituras de hoy, significado, aplicación y actualizaciones de trivia bíblica. Estos correos están personalizados con su nombre.",
    sendGridLabel: "Proveedor de Servicios de Correo:",
    sendGridDesc: "Usamos SendGrid, un servicio de entrega de correo electrónico de terceros de confianza, para enviar correos de recordatorio diarios. SendGrid puede procesar su dirección de correo y nombre para entregar estos correos. Vea la política de privacidad de SendGrid en https://www.twilio.com/legal/privacy",
    unsubscribeLabel: "Darse de Baja:",
    unsubscribeDesc: "Puede darse de baja de los correos diarios en cualquier momento haciendo clic en el enlace de cancelación al final de cualquier correo, o desactivando los Recordatorios Diarios en la configuración de la aplicación. Su solicitud se procesará inmediatamente.",
  ...
  fr: {
    ...
    emailCommunicationsLabel: "Rappels Quotidiens :",
    emailCommunicationsDesc: "Si vous vous abonnez aux e-mails de rappel quotidien, vous recevrez un e-mail par jour à 7h00 avec le verset des Écritures d'aujourd'hui, la signification, l'application et les mises à jour du trivia biblique. Ces e-mails sont personnalisés avec votre prénom.",
    sendGridLabel: "Fournisseur de Services E-mail :",
    sendGridDesc: "Nous utilisons SendGrid, un service de livraison d'e-mails tiers de confiance, pour envoyer des e-mails de rappel quotidiens. SendGrid peut traiter votre adresse e-mail et votre nom pour livrer ces e-mails. Consultez la politique de confidentialité de SendGrid sur https://www.twilio.com/legal/privacy",
    unsubscribeLabel: "Se Désabonner :",
    unsubscribeDesc: "Vous pouvez vous désabonner des e-mails quotidiens à tout moment en cliquant sur le lien de désabonnement au bas de n'importe quel e-mail, ou en désactivant les Rappels Quotidiens dans les paramètres de l'application. Votre demande sera traitée immédiatement.",
  ...
  pt: {
    ...
    emailCommunicationsLabel: "Lembretes Diários:",
    emailCommunicationsDesc: "Se você se inscrever para receber e-mails de lembrete diário, receberá um e-mail por dia às 7h com o versículo das Escrituras de hoje, significado, aplicação e atualizações de trivia bíblica. Esses e-mails são personalizados com seu primeiro nome.",
    sendGridLabel: "Provedor de Serviços de E-mail:",
    sendGridDesc: "Usamos o SendGrid, um serviço confiável de entrega de e-mail de terceiros, para enviar e-mails de lembrete diários. O SendGrid pode processar seu endereço de e-mail e nome para entregar esses e-mails. Veja a política de privacidade do SendGrid em https://www.twilio.com/legal/privacy",
    unsubscribeLabel: "Cancelar Inscrição:",
    unsubscribeDesc: "Você pode cancelar a inscrição de e-mails diários a qualquer momento clicando no link de cancelamento no final de qualquer e-mail, ou desativando os Lembretes Diários nas configurações do aplicativo. Sua solicitação será processada imediatamente.",
  ...
  zh: {
    ...
    emailCommunicationsLabel: "每日提醒：",
    emailCommunicationsDesc: "如果您订阅每日提醒电子邮件，您将在每天上午7:00收到一封包含今日经文、含义、应用和圣经小知识更新的电子邮件。这些电子邮件使用您的名字进行个性化。",
    sendGridLabel: "电子邮件服务提供商：",
    sendGridDesc: "我们使用SendGrid（一个值得信赖的第三方电子邮件传递服务）发送每日提醒电子邮件。SendGrid可能会处理您的电子邮件地址和姓名以传递这些电子邮件。在https://www.twilio.com/legal/privacy查看SendGrid的隐私政策",
    unsubscribeLabel: "取消订阅：",
    unsubscribeDesc: "您可以随时通过点击任何电子邮件底部的取消订阅链接或在应用程序设置中关闭每日提醒来取消订阅每日电子邮件。您的取消订阅请求将立即处理。",
  ...
  ar: {
    ...
    emailCommunications: "الاتصالات عبر البريد الإلكتروني",
    emailCommunicationsLabel: "التذكيرات اليومية:",
    emailCommunicationsDesc: "إذا اشتركت في رسائل التذكير اليومية عبر البريد الإلكتروني، فستتلقى بريدًا إلكترونيًا واحدًا يوميًا في تمام الساعة 7:00 صباحًا يحتوي على آية الكتاب المقدس اليوم والمعنى والتطبيق وتحديثات التوافه الكتابية. هذه الرسائل الإلكترونية مخصصة باستخدام اسمك الأول.",
    sendGridLabel: "مزود خدمة البريد الإلكتروني:",
    sendGridDesc: "نستخدم SendGrid، وهي خدمة تسليم بريد إلكتروني موثوقة من طرف ثالث، لإرسال رسائل التذكير اليومية عبر البريد الإلكتروني. قد تقوم SendGrid بمعالجة عنوان بريدك الإلكتروني واسمك لتسليم هذه الرسائل الإلكترونية. اعرض سياسة خصوصية SendGrid على https://www.twilio.com/legal/privacy",
    unsubscribeLabel: "إلغاء الاشتراك:",
    unsubscribeDesc: "يمكنك إلغاء الاشتراك في رسائل البريد الإلكتروني اليومية في أي وقت من خلال النقر على رابط إلغاء الاشتراك في أسفل أي بريد إلكتروني، أو عن طريق إيقاف التذكيرات اليومية في إعدادات التطبيق. سيتم معالجة طلب إلغاء الاشتراك الخاص بك على الفور.",
  ...
  hi: {
    ...
    emailCommunications: "ईमेल संचार",
    emailCommunicationsLabel: "दैनिक अनुस्मारक:",
    emailCommunicationsDesc: "यदि आप दैनिक अनुस्मारक ईमेल की सदस्यता लेते हैं, तो आपको सुबह 7:00 बजे एक ईमेल प्राप्त होगा जिसमें आज का पवित्रशास्त्र वचन, अर्थ, अनुप्रयोग और बाइबिल ट्रिविया अपडेट होंगे। ये ईमेल आपके पहले नाम का उपयोग करके व्यक्तिगत बनाई जाती हैं।",
    sendGridLabel: "ईमेल सेवा प्रदाता:",
    sendGridDesc: "हम दैनिक अनुस्मारक ईमेल भेजने के लिए SendGrid, एक विश्वसनीय तृतीय-पक्ष ईमेल वितरण सेवा का उपयोग करते हैं। SendGrid इन ईमेल को वितरित करने के लिए आपके ईमेल पते और नाम को संसाधित कर सकता है। https://www.twilio.com/legal/privacy पर SendGrid की गोपनीयता नीति देखें",
    unsubscribeLabel: "सदस्यता समाप्त करें:",
    unsubscribeDesc: "आप किसी भी ईमेल के नीचे सदस्यता समाप्त करें लिंक पर क्लिक करके, या ऐप सेटिंग्स में दैनिक अनुस्मारक बंद करके किसी भी समय दैनिक ईमेल से सदस्यता समाप्त कर सकते हैं। आपका सदस्यता समाप्त अनुरोध तुरंत संसाधित किया जाएगा।",
