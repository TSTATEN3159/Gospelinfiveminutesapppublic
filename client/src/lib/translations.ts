...
export const translations: Record<string, Translations> = {
  ...
  es: {
    ...
    receiveNewsletters: "Optar por recibir actualizaciones por correo",
  ...
  fr: {
    ...
    receiveNewsletters: "S'inscrire pour recevoir des mises à jour par e-mail",
  ...
  pt: {
    ...
    receiveNewsletters: "Optar por receber atualizações por e-mail",
  ...
  ar: {
    ...
    receiveNewsletters: "اختر تلقي تحديثات البريد الإلكتروني",
  ...
  hi: {
    ...
    receiveNewsletters: "ईमेल अपडेट प्राप्त करने के लिए चुनें",
