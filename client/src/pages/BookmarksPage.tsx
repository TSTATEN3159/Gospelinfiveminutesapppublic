        ...
        <Card className="border-slate-200 dark:border-slate-800">
          ...
          <CardContent className="space-y-3">
            <div className="flex gap-2">
              ...
              />
              <Button size="icon" onClick={handleAddFolder} data-testid="button-add-folder">
            ...
            {bookmarks.map((bm) => (
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      onClick={() => handleNavigateToReference(bm.reference)}
                ...
                {editingNoteId === bm.id ? (
                  ...
                  <div
                    className="text-sm text-slate-700 dark:text-slate-200 whitespace-pre-wrap cursor-pointer"
