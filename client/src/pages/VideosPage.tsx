...
import { Play, Clock, Users, Heart, Lightbulb, BookOpen, ExternalLink } from "lucide-react";
      ...
      <div className="bg-white dark:bg-gray-900 px-6 py-8 border-b border-slate-200 dark:border-slate-800 ios-safe-top">
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex-1 text-center">
            <h1 className="text-4xl font-bold bg-gradient-to-r from-slate-800 via-blue-800 to-indigo-800 bg-clip-text text-transparent dark:from-slate-200 dark:via-blue-300 dark:to-indigo-300 mb-3" style={{ 
